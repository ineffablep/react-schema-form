...
var PlaceInput = function (_React$Component) {
  ...
  _createClass(PlaceInput, [{
    ...
    value: function componentWillMount() {
      var key = this.props.key || "AIzaSyCoq4_-BeKtYRIs-3FjJL721G1eP5DaU0g",
    ...
    value: function getPredictions(value) {
      ...
      if (value.length) {
        if (window.google) {
          ...
          this.googleService.getQueryPredictions({ input: value }, function (predictions, status) {
